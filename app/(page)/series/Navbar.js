...
const path = usePathname()
  return (
    <div className='w-full flex header sticky bottom-0 md:hidden py-1 px-7 text-[10px] text-gray-400 bg-gray-800  items-center justify-between overflow-hidden z-50'>
        ...
        <Link className={path === '/movie' ? 'text-white flex flex-col items-center' : 'flex flex-col items-center'  } href='/movie'>{<BiSolidMoviePlay size={25}/>}Movie</Link>
        ...
        <Link className='text-white flex flex-col items-center' href='/series'><PiTelevisionSimpleFill size={25}/>Series</Link>
