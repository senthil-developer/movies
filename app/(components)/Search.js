...
const Search = () => {
  ...
  return (
    <div className='w-full  sticky top-0 h-20  '>
        ...
        <form id='searchForm' name='searchInput'  onSubmit={handleSubmit} className='flex w-[50%] mt-5 mx-auto max-w-[90%] border-gray-300 border justify-between py-3 px-5 rounded-full focus-within:shadow-md hover:shadow-md transition-shadow items-center sm:max-w-xl  lg:max-w-2xl bg-white'>
